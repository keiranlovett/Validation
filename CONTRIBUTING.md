...
1. Make an [Issue](https://github.com/keiran/unity-validation/issues/new)
...
```json
    {
        "dependencies": {
            "com.keiran.unity-validation": "https://github.com/YOUR_USER/unity-validation.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at kvclovett@gmail.com.
